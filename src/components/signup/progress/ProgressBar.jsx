...
const ProgressBar = ({ children }) => {
  ...
  return (
    <div className="pt-[30px]" id="progress">
      <div
        className="relative max-w-[520px] mx-auto flex items-center bg-white h-[18px] rounded-[100px] dark:bg-[#3e4e69]"
        id="progress-bar"
      >
        <div
        ...
        >
          <div
            className="absolute top-0 left-0 h-full bg-[#eaeaea] w-full rounded-[100px] dark:bg-[#2b3649]"
            id="track"
          ></div>
          <div
