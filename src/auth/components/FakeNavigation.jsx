...
const FakeNavigation = () => {
  ...
  return (
    <nav className='fake-nav relative flex-center w-full h-[55px] bg-white dark:bg-[#1c2330]'>
      ...
      <button
        id='theme-toggle'
        className='absolute end-10 text-gray-500 inline-flex-center dark:text-gray-400 hover:bg-gray-100 w-8 h-8 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-full text-sm p-1'
        onClick={() => changePreference()}>
        {/* <img src={theme === 'dark' ? lightIcon : darkIcon} className='w-4 h-4' alt='theme toggle' /> */}
