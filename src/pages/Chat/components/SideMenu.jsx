...
const SideMenu = ({ user }) => (
  <div className="relative w-[100vw] h-[60px] lg:w-16 lg:min-h-screen side-menu order-last lg:order-first pb-4 pe-5 px-2 lg:px-0 pt-3 bg-[#2e2e2e]">
    <div className="h-full flex flex-1 lg:flex-col items-center justify-between">
      ...
      <div className="flex items-center w-full justify-center lg:justify-normal lg:flex-col">
        <ul
          role="tablist"
          className="flex lg:flex-grow-0 lg:flex-col items-center gap-7 sm:gap-14 lg:mt-8 lg:gap-8"
        >
          <Link to="/">
