  ...
  return (
    <>
      {selectedUser && (
        <div
          className={cn(
            "user-profile-sidebar absolute inset-y-0 right-0 lg:relative z-20 bg-white dark:bg-[#262626]",
            showUserInfo ? "" : "hidden",
          )}
        >
          <div className="">
                  ...
                  <div className="user-chat-nav p-2">
                    <div className="flex w-full text-white">
                      <div className="flex items-center flex-grow">
                        <button className="bx bx-x w-10 h-10 text-[21px]"></button>
                      </div>
            ...
            <div className="user-profile-desc p-4">
              <div>
                <button className="flex-center w-full gap-2 text-pink-500">
                  <i
                    className={cn(
                      "bx",
                      selectedUser.favourite ? "bxs-heart" : "bx-heart",
                    )}
                  ></i>
              ...
              <div>
                ...
                <p className="text-sm opacity-65 dark:text-gray-100">
                  {selectedUser.bio ? (
                    ...
                    <em className="text-xs opacity-50">User has no bio</em>
                  )}
                </p>
              </div>
              <hr className="my-4 dark:opacity-10" />
